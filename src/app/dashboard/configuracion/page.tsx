    ...
    return (
      <div className="flex items-center justify-center h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-400 dark:text-slate-500">Cargando configuración...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-[800px] mx-auto">
      <div>
        ...
        <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Ajustes de tu cuenta y gestión del sistema</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700/60 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Mi Perfil</h3>
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700/60 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Sistema</h3>
          </div>
